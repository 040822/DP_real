...
from source.model.CDP2.transformer_for_diffusion_causal import TransformerForDiffusion
from source.model.CDP2.mask_generator import LowdimMaskGenerator
from source.model.CDP2.pointnet_extractor import DP3Encoder
from source.model.CDP2.multi_image_obs_encoder import MultiImageObsEncoder

class CDP2(LightningModule):
    def __init__(self, 
            shape_meta: dict,
