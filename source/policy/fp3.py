...
from source.model.FP3.sde_lib import ConsistencyFM
from source.model.FP3.conditional_unet1d import ConditionalUnet1D
from source.model.FP3.mask_generator import LowdimMaskGenerator
from source.model.FP3.pointnet_extractor import FlowPolicyEncoder
import warnings
...
class FlowPolicy(BasePolicy):
    ...
    def compute_loss(self, batch):
        ...
        condition_mask = self.mask_generator(trajectory.shape, self.device)
        # gt & noise
        target = target
